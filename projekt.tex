...
Začal som s tým, že som si stiahol súbor dostatočne veľký, aby pokrýval nadpolovičnú vačšinu z partície. Na toto som využil obrázok od NASA JWST\footnote{James Webb Space Telescope}, ktorý mal veľkosť 130MB.
...
\begin{figure}[H]
	\centering
	\captionsetup{justification=centering,margin=2cm}
	\includegraphics[width=\linewidth]{./images/testdisk_testing/gparted-setup.png}
	\centering
...
\begin{figure}[H]
	\centering
	\captionsetup{justification=centering,margin=2cm}
	\includegraphics[width=\linewidth]{./images/testdisk_testing/disk-mount-gnome-disks.png}
	\centering
