...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.8]{./images/testdisk_testing/testdisk_deleted_file_recovery.png}
	\centering
	\captionsetup{justification=centering,margin=2cm}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.9]{./images/testdisk_testing/testdisk_deleted_file_recovery2.png}
	\centering
	\captionsetup{justification=centering,margin=2cm}
