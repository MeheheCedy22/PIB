...
\begin{figure}[H]
	...
	\includegraphics[width=\linewidth]{fat-file-system-structure.png}
	\centering
...
Windows 8 a novšie verzie natívne podporujú bootovanie z exFAT.\cite{EXFAT}
...
\begin{figure}[H]
	\centering
	\captionsetup{justification=centering,margin=2cm}
	\includegraphics[width=\linewidth]{exfat-file-system-structure.png}
	\centering
	\caption{Štruktúra súborového systému FAT a FAT32 \\ Zdroj: https://www.easeus.com/diskmanager/file-system.html}
\end{figure}
...
\section{Záver}
Temp citovanie vsetkych citacii na ich zobrazenie.\cite{TSDK,NTFS,NTFS2,NTFS3,FAT,EXT,ALLFS,FS,NTvsFAT,EXFAT}
